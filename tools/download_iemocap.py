...
#
# 用法：
#   python tools/download_iemocap.py --output-dir datasets/IEMOCAP
#
...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "datasets/IEMOCAP"
...
def build_parser():
    parser = argparse.ArgumentParser(description="下载并解包 IEMOCAP 数据集")
...
def main():
    ...
    hf_cache = output_dir / "_hf_parquet"
