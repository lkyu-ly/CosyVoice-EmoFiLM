...
def init_dataset_and_dataloader(args, configs, gan, dpo):
    ...
    if args.num_workers > 0:
        loader_options['prefetch_factor'] = args.prefetch
    train_data_loader = DataLoader(train_dataset, **loader_options)
    cv_data_loader = DataLoader(cv_dataset, **loader_options)
    ...
    if info_dict["batch_idx"] != 0:
        ...
        try:
            try:
                ...
                timeout = datetime.timedelta(seconds=60)  # torch>=2.x ProcessGroup 无 .options
